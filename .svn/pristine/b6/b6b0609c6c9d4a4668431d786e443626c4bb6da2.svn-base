...
public class DeleteRoomAdapter extends BaseAdapter{
	Context mContext;
	...
	public DeleteRoomAdapter(Context context, int layout, ArrayList<WeddingListItem> wedding_list_item){
		mContext = context;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ImageView delete_room_btn = (ImageView)convertView.findViewById(R.id.delete_room_btn);
